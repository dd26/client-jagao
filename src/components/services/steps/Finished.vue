<template>
  <section class="column absolute-full" style="background-color: #D9F2EE">
    <div class="col-7 container-img-2"></div>
    <div class="col- column">
      <div class="q-pt-lg window-width row justify-center col-1">
        <div
          class="text-bold text-center col-12 text-primary q-pt-lg q-px-xl"
          style="font-weight: 700; font-size: 20px;"
        >
          Order made <br> successfully!
        </div>
